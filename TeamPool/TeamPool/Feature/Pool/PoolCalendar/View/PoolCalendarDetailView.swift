...
final class PoolCalendarDetailView: BaseUIView {
    ...
    func update(date: Date, events: [PoolCalendarModel]) {
    ...
    private func makeEventCard(for event: PoolCalendarModel) -> UIView {
        let card = UIView()
